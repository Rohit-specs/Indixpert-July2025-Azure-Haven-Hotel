...
# file_path=path+"/database/menu.json"
...
class show_menu:
    def __init__(self):
        ...
        for key,dishes in data.items():
            ...
            # if "half_plate" in dishes and "full_plate" in dishes:
            #     print("| DISHES \t\t Half Plate Price \t Full Plate Price" )
            flag=1
            for dish in dishes:
                item=dish["item"]
                ...
                #     print("| DISHES \t\t Price")
                    ...
                    # spaces3=" "*(58-len(item)-len(dish["price"]))+"|"
                    # spaces3=" "*28+"|"
                    if flag==1:
