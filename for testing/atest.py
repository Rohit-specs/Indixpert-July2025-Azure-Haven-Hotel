...
obj=Report_data().current_month_total_revenue()
obj=Report_data().no_of_booking()
obj=Report_data().current_number_of_booking()
obj=Report_data().average_booking_duration()
obj=Report_data().current_month_average_booking_duration()
obj=Report_data().most_ordered_dish()
obj=Report_data().current_month_most_ordered_dish()
obj=Report_data().payment_method_used()
obj=Report_data().current_month_payment_method_used()
obj=Report_data().total_revenue()
